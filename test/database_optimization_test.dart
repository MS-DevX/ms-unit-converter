...
void main() {
  ...
  group('Phase A3 — Database Optimization & Health Diagnostics', () {
    test('DatabaseHealthService reports healthy database status', () async {
      ...
      expect(result.contentVersion, equals('2.3.5'));
      ...
      expect(result.tableCounts['collections'], equals(32));
      expect(result.tableCounts['collection_items'], equals(207));
      expect(result.tableCounts['educational_facts'], equals(742));
      expect(result.tableCounts['search_aliases'], equals(779));
