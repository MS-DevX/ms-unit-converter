...
- **Supported:** 30 currencies (defined in `lib/data/currencies_data.dart`)
- **Fallback:** Hardcoded approximate rates (same file), used on first launch or offline
- **Caching:** Rates + timestamp saved to SharedPreferences
